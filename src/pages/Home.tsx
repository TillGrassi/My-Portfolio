      ...
      <section className="pt-24 pb-16 bg-gradient-to-b from-white to-warm-gray">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Landscape paintings that capture the emotional essence of nature
            through neo-impressionist brushwork and vibrant colors
          </p>
          <a
            href="#gallery"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Landscape painter capturing the emotional essence of nature
                through neo-impressionist brushwork and vibrant colors.
              </p>
            </div>
